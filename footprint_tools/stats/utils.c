...
#define __PYX_HAVE__footprint_tools__stats__utils
#define __PYX_HAVE_API__footprint_tools__stats__utils
/* Early includes */
#include <string.h>
#include <stdio.h>
...
static const char *__pyx_f[] = {
  "footprint_tools/stats/utils.pyx",
  "__init__.pxd",
  "stringsource",
  "type.pxd",
};
...
/* "footprint_tools/stats/utils.pyx":13
 * import numpy as np
 * 
 ...
 */
typedef __pyx_t_5numpy_float64_t __pyx_t_15footprint_tools_5stats_5utils_data_type_t;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
struct __pyx_opt_args_15footprint_tools_5stats_5utils_segment;

/* "footprint_tools/stats/utils.pyx":15
 * ctypedef np.float64_t data_type_t
 * 
 * cpdef segment(data_type_t [:] x, data_type_t threshold, int w = 1, bint decreasing = 0):             # <<<<<<<<<<<<<<
...
static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_15footprint_tools_5stats_5utils_data_type_t(PyObject *, int writable_flag);
...
/* Module declarations from 'footprint_tools.stats.utils' */
...
static PyObject *__pyx_f_15footprint_tools_5stats_5utils_segment(__Pyx_memviewslice, __pyx_t_15footprint_tools_5stats_5utils_data_type_t, int __pyx_skip_dispatch, struct __pyx_opt_args_15footprint_tools_5stats_5utils_segment *__pyx_optional_args); /*proto*/
static PyObject *__pyx_f_15footprint_tools_5stats_5utils_bisect(__Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_15footprint_tools_5stats_5utils_data_type_t = { "data_type_t", NULL, sizeof(__pyx_t_15footprint_tools_5stats_5utils_data_type_t), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "footprint_tools.stats.utils"
extern int __pyx_module_is_main_footprint_tools__stats__utils;
int __pyx_module_is_main_footprint_tools__stats__utils = 0;

/* Implementation of 'footprint_tools.stats.utils' */
...
static PyObject *__pyx_pf_15footprint_tools_5stats_5utils_segment(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, __pyx_t_15footprint_tools_5stats_5utils_data_type_t __pyx_v_threshold, int __pyx_v_w, int __pyx_v_decreasing); /* proto */
static PyObject *__pyx_pf_15footprint_tools_5stats_5utils_2bisect(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b); /* proto */
...
static PyObject *__pyx_pw_15footprint_tools_5stats_5utils_1segment(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_15footprint_tools_5stats_5utils_segment(__Pyx_memviewslice __pyx_v_x, __pyx_t_15footprint_tools_5stats_5utils_data_type_t __pyx_v_threshold, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_15footprint_tools_5stats_5utils_segment *__pyx_optional_args) {
  int __pyx_v_w = ((int)1);
  int __pyx_v_decreasing = ((int)0);
  double __pyx_v_dir;
  ...
  if (__pyx_optional_args) {
    if (__pyx_optional_args->__pyx_n > 0) {
      ...
      if (__pyx_optional_args->__pyx_n > 1) {
        __pyx_v_decreasing = __pyx_optional_args->decreasing;
      }
    }
  }

  /* "footprint_tools/stats/utils.pyx":35
 * 
 *     """
 ...
 */
  ...
  /* "footprint_tools/stats/utils.pyx":37
 *     cdef double dir = -1 if decreasing else 1
 * 
 *     cdef list ret = []             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "footprint_tools/stats/utils.pyx":38
 * 
 *     cdef list ret = []
 *     cdef int i, curr_start = -1             # <<<<<<<<<<<<<<
 *     for i in range(x.shape[0]):
 *         if curr_start < 0:
 */
  __pyx_v_curr_start = -1;

  /* "footprint_tools/stats/utils.pyx":39
 *     cdef list ret = []
 *     cdef int i, curr_start = -1
 *     for i in range(x.shape[0]):             # <<<<<<<<<<<<<<
 *         if curr_start < 0:
 ...
 */
  ...
  for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_4; __pyx_t_5+=1) {
    ...
    /* "footprint_tools/stats/utils.pyx":40
 *     cdef int i, curr_start = -1
 *     for i in range(x.shape[0]):
 *         if curr_start < 0:             # <<<<<<<<<<<<<<
 *             if dir*x[i] >= dir*threshold:
 *                 curr_start = i-w+1
 */
    __pyx_t_6 = ((__pyx_v_curr_start < 0) != 0);
    if (__pyx_t_6) {

      /* "footprint_tools/stats/utils.pyx":41
 *     for i in range(x.shape[0]):
 *         if curr_start < 0:
 *             if dir*x[i] >= dir*threshold:             # <<<<<<<<<<<<<<
 *                 curr_start = i-w+1
 ...
 */
      ...
      } else if (unlikely(__pyx_t_7 >= __pyx_v_x.shape[0])) __pyx_t_8 = 0;
      if (unlikely(__pyx_t_8 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_8);
        __PYX_ERR(0, 41, __pyx_L1_error)
      }
      __pyx_t_6 = (((__pyx_v_dir * (*((__pyx_t_15footprint_tools_5stats_5utils_data_type_t *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_7 * __pyx_v_x.strides[0]) )))) >= (__pyx_v_dir * __pyx_v_threshold)) != 0);
      if (__pyx_t_6) {

        /* "footprint_tools/stats/utils.pyx":42
 *         if curr_start < 0:
 *             if dir*x[i] >= dir*threshold:
 *                 curr_start = i-w+1             # <<<<<<<<<<<<<<
 *         else:
 *             if dir*x[i] < dir*threshold:
 */
        __pyx_v_curr_start = ((__pyx_v_i - __pyx_v_w) + 1);
 ...
 */
    ...
    /* "footprint_tools/stats/utils.pyx":44
 *                 curr_start = i-w+1
 *         else:
 *             if dir*x[i] < dir*threshold:             # <<<<<<<<<<<<<<
 ...
 */
    /*else*/ {
      ...
      if (__pyx_t_6) {
        ...
        /* "footprint_tools/stats/utils.pyx":45
 *         else:
 *             if dir*x[i] < dir*threshold:
 *                 if len(ret) > 0 and curr_start <= ret[-1][1]:             # <<<<<<<<<<<<<<
 *                     ret[-1][1] = i-1+w
 *                 else:
 */
        __pyx_t_9 = PyList_GET_SIZE(__pyx_v_ret); if (unlikely(__pyx_t_9 == ((Py_ssize_t)-1))) __PYX_ERR(0, 45, __pyx_L1_error)
        ...
        __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_curr_start); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 45, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_2);
        __pyx_t_11 = __Pyx_GetItemInt_List(__pyx_v_ret, -1L, long, 1, __Pyx_PyInt_From_long, 1, 1, 1); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 45, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_11);
        __pyx_t_12 = __Pyx_GetItemInt(__pyx_t_11, 1, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 45, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_12);
        __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
        __pyx_t_11 = PyObject_RichCompare(__pyx_t_2, __pyx_t_12, Py_LE); __Pyx_XGOTREF(__pyx_t_11); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 45, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
        __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
        __pyx_t_10 = __Pyx_PyObject_IsTrue(__pyx_t_11); if (unlikely(__pyx_t_10 < 0)) __PYX_ERR(0, 45, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
        __pyx_t_6 = __pyx_t_10;
        __pyx_L9_bool_binop_done:;
        if (__pyx_t_6) {

          /* "footprint_tools/stats/utils.pyx":46
 *             if dir*x[i] < dir*threshold:
 *                 if len(ret) > 0 and curr_start <= ret[-1][1]:
 *                     ret[-1][1] = i-1+w             # <<<<<<<<<<<<<<
 *                 else:
 ...
 */
          __pyx_t_11 = __Pyx_PyInt_From_long(((__pyx_v_i - 1) + __pyx_v_w)); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 46, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_11);
          __pyx_t_12 = __Pyx_GetItemInt_List(__pyx_v_ret, -1L, long, 1, __Pyx_PyInt_From_long, 1, 1, 1); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 46, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_12);
          if (unlikely(__Pyx_SetItemInt(__pyx_t_12, 1, __pyx_t_11, long, 1, __Pyx_PyInt_From_long, 0, 0, 1) < 0)) __PYX_ERR(0, 46, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
          __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
 ...
 */
        ...
        /* "footprint_tools/stats/utils.pyx":48
 *                     ret[-1][1] = i-1+w
 *                 else:
 *                     ret.append( [curr_start, i-1+w] )             # <<<<<<<<<<<<<<
 *                 curr_start = -1
 ...
 */
        /*else*/ {
          __pyx_t_11 = __Pyx_PyInt_From_int(__pyx_v_curr_start); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 48, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_11);
          __pyx_t_12 = __Pyx_PyInt_From_long(((__pyx_v_i - 1) + __pyx_v_w)); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 48, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_12);
          ...
          __pyx_t_11 = 0;
          __pyx_t_12 = 0;
          __pyx_t_13 = __Pyx_PyList_Append(__pyx_v_ret, __pyx_t_2); if (unlikely(__pyx_t_13 == ((int)-1))) __PYX_ERR(0, 48, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
        }
        __pyx_L8:;

        /* "footprint_tools/stats/utils.pyx":49
 *                 else:
 *                     ret.append( [curr_start, i-1+w] )
 *                 curr_start = -1             # <<<<<<<<<<<<<<
 *     return ret
 ...
 */
  ...
  /* "footprint_tools/stats/utils.pyx":50
 *                     ret.append( [curr_start, i-1+w] )
 *                 curr_start = -1
 *     return ret             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("footprint_tools.stats.utils.segment", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_15footprint_tools_5stats_5utils_1segment(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_15footprint_tools_5stats_5utils_segment[] = "Segment an array into continuous elements passing a threshold\n\n    Parameters\n    ---------\n    x : array_like\n        Array of values to segment\n    threshold : float\n        Threshold for grouping elements\n    w : int\n        Window size\n    decreasing : bool\n\n    Returns\n    -------\n    out : list\n        List of tuples which specific the start and end index \n        of contiguous intervals that pass threshold\n\n    ";
static PyObject *__pyx_pw_15footprint_tools_5stats_5utils_1segment(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_x = { 0, 0, { 0 }, { 0 }, { 0 } };
  __pyx_t_15footprint_tools_5stats_5utils_data_type_t __pyx_v_threshold;
  int __pyx_v_w;
  int __pyx_v_decreasing;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_x,&__pyx_n_s_threshold,&__pyx_n_s_w,&__pyx_n_s_decreasing,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_threshold)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("segment", 0, 2, 4, 1); __PYX_ERR(0, 15, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (kw_args > 0) {
        ...
        case  3:
        if (kw_args > 0) {
          PyObject* value = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_decreasing);
          if (value) { values[3] = value; kw_args--; }
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "segment") < 0)) __PYX_ERR(0, 15, __pyx_L3_error)
      }
    } else {
    ...
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_15footprint_tools_5stats_5utils_data_type_t(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_x.memview)) __PYX_ERR(0, 15, __pyx_L3_error)
    __pyx_v_threshold = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_threshold == ((npy_float64)-1)) && PyErr_Occurred())) __PYX_ERR(0, 15, __pyx_L3_error)
    if (values[2]) {
      __pyx_v_w = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_w == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 15, __pyx_L3_error)
    } else {
      __pyx_v_w = ((int)1);
    }
    if (values[3]) {
      __pyx_v_decreasing = __Pyx_PyObject_IsTrue(values[3]); if (unlikely((__pyx_v_decreasing == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 15, __pyx_L3_error)
    } else {
      __pyx_v_decreasing = ((int)0);
    }
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("segment", 0, 2, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 15, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("footprint_tools.stats.utils.segment", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_15footprint_tools_5stats_5utils_segment(__pyx_self, __pyx_v_x, __pyx_v_threshold, __pyx_v_w, __pyx_v_decreasing);
...
static PyObject *__pyx_pf_15footprint_tools_5stats_5utils_segment(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, __pyx_t_15footprint_tools_5stats_5utils_data_type_t __pyx_v_threshold, int __pyx_v_w, int __pyx_v_decreasing) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  struct __pyx_opt_args_15footprint_tools_5stats_5utils_segment __pyx_t_2;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("segment", 0);
  ...
  __pyx_t_2.decreasing = __pyx_v_decreasing;
  __pyx_t_1 = __pyx_f_15footprint_tools_5stats_5utils_segment(__pyx_v_x, __pyx_v_threshold, 0, &__pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 15, __pyx_L1_error)
...
/* "footprint_tools/stats/utils.pyx":52
 *     return ret
 * 
 * cpdef bisect(data_type_t [:] a, data_type_t [:] b):             # <<<<<<<<<<<<<<
 *     """Bisect arrays
...
static PyObject *__pyx_pw_15footprint_tools_5stats_5utils_3bisect(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_15footprint_tools_5stats_5utils_bisect(__Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_i;
  int __pyx_v_n;
  int __pyx_v_lo;
  int __pyx_v_hi;
  ...
  /* "footprint_tools/stats/utils.pyx":67
 *     """
 *     cdef int i
 ...
 */
  ...
  /* "footprint_tools/stats/utils.pyx":69
 *     cdef int n = b.shape[0]
 * 
 *     cdef int lo = 0             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "footprint_tools/stats/utils.pyx":70
 * 
 *     cdef int lo = 0
 *     cdef int hi = a.shape[0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_hi = (__pyx_v_a.shape[0]);

  /* "footprint_tools/stats/utils.pyx":72
 *     cdef int hi = a.shape[0]
 * 
 *     cdef np.ndarray[data_type_t, ndim = 1] ind = np.zeros(n, dtype = np.float64)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_n); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_float64); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 72, __pyx_L1_error)
  ...
  __pyx_t_6 = ((PyArrayObject *)__pyx_t_5);
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_ind.rcbuffer->pybuffer, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_nn___pyx_t_15footprint_tools_5stats_5utils_data_type_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
  ...
  /* "footprint_tools/stats/utils.pyx":74
 *     cdef np.ndarray[data_type_t, ndim = 1] ind = np.zeros(n, dtype = np.float64)
 * 
 *     for i in range(n):             # <<<<<<<<<<<<<<
 *         while lo < hi:
 ...
 */
  ...
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    ...
    /* "footprint_tools/stats/utils.pyx":75
 * 
 *     for i in range(n):
 *         while lo < hi:             # <<<<<<<<<<<<<<
 *             if b[i] < a[lo]: break
 ...
 */
    while (1) {
      __pyx_t_10 = ((__pyx_v_lo < __pyx_v_hi) != 0);
      if (!__pyx_t_10) break;

      /* "footprint_tools/stats/utils.pyx":76
 *     for i in range(n):
 *         while lo < hi:
 *             if b[i] < a[lo]: break             # <<<<<<<<<<<<<<
 *             else: lo = lo + 1
 ...
 */
      ...
      } else if (unlikely(__pyx_t_11 >= __pyx_v_b.shape[0])) __pyx_t_12 = 0;
      if (unlikely(__pyx_t_12 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_12);
        __PYX_ERR(0, 76, __pyx_L1_error)
      }
      __pyx_t_13 = __pyx_v_lo;
      __pyx_t_12 = -1;
      if (__pyx_t_13 < 0) {
        __pyx_t_13 += __pyx_v_a.shape[0];
        if (unlikely(__pyx_t_13 < 0)) __pyx_t_12 = 0;
      } else if (unlikely(__pyx_t_13 >= __pyx_v_a.shape[0])) __pyx_t_12 = 0;
      if (unlikely(__pyx_t_12 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_12);
        __PYX_ERR(0, 76, __pyx_L1_error)
      }
      __pyx_t_10 = (((*((__pyx_t_15footprint_tools_5stats_5utils_data_type_t *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_11 * __pyx_v_b.strides[0]) ))) < (*((__pyx_t_15footprint_tools_5stats_5utils_data_type_t *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_13 * __pyx_v_a.strides[0]) )))) != 0);
      if (__pyx_t_10) {
        goto __pyx_L6_break;
      }

      /* "footprint_tools/stats/utils.pyx":77
 *         while lo < hi:
 *             if b[i] < a[lo]: break
 *             else: lo = lo + 1             # <<<<<<<<<<<<<<
 *         ind[i] = lo
 ...
 */
    ...
    /* "footprint_tools/stats/utils.pyx":78
 *             if b[i] < a[lo]: break
 *             else: lo = lo + 1
 *         ind[i] = lo             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_12 = -1;
    if (__pyx_t_13 < 0) {
      __pyx_t_13 += __pyx_pybuffernd_ind.diminfo[0].shape;
      if (unlikely(__pyx_t_13 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_13 >= __pyx_pybuffernd_ind.diminfo[0].shape)) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 78, __pyx_L1_error)
    }
    *__Pyx_BufPtrStrided1d(__pyx_t_15footprint_tools_5stats_5utils_data_type_t *, __pyx_pybuffernd_ind.rcbuffer->pybuffer.buf, __pyx_t_13, __pyx_pybuffernd_ind.diminfo[0].strides) = __pyx_v_lo;
  }

  /* "footprint_tools/stats/utils.pyx":80
 *         ind[i] = lo
 * 
 *     return ind             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __Pyx_AddTraceback("footprint_tools.stats.utils.bisect", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_ind.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_15footprint_tools_5stats_5utils_3bisect(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_15footprint_tools_5stats_5utils_2bisect[] = "Bisect arrays\n\n    Parameters\n    ----------\n    a : array_like\n        \n    b : array_like\n\n    Returns\n    -------\n    out : ndarray\n        Bisected list\n    ";
static PyObject *__pyx_pw_15footprint_tools_5stats_5utils_3bisect(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("bisect (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_b)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("bisect", 1, 2, 2, 1); __PYX_ERR(0, 52, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "bisect") < 0)) __PYX_ERR(0, 52, __pyx_L3_error)
      }
    ...
    __pyx_v_a = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_15footprint_tools_5stats_5utils_data_type_t(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_a.memview)) __PYX_ERR(0, 52, __pyx_L3_error)
    __pyx_v_b = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_15footprint_tools_5stats_5utils_data_type_t(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_b.memview)) __PYX_ERR(0, 52, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("bisect", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 52, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("footprint_tools.stats.utils.bisect", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_15footprint_tools_5stats_5utils_2bisect(__pyx_self, __pyx_v_a, __pyx_v_b);
...
static PyObject *__pyx_pf_15footprint_tools_5stats_5utils_2bisect(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("bisect", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_a.memview)) { __Pyx_RaiseUnboundLocalError("a"); __PYX_ERR(0, 52, __pyx_L1_error) }
  if (unlikely(!__pyx_v_b.memview)) { __Pyx_RaiseUnboundLocalError("b"); __PYX_ERR(0, 52, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_15footprint_tools_5stats_5utils_bisect(__pyx_v_a, __pyx_v_b, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "footprint_tools.stats.utils.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "footprint_tools.stats.utils.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "footprint_tools.stats.utils.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "footprint_tools.stats.utils._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"segment", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_15footprint_tools_5stats_5utils_1segment, METH_VARARGS|METH_KEYWORDS, __pyx_doc_15footprint_tools_5stats_5utils_segment},
  {"bisect", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_15footprint_tools_5stats_5utils_3bisect, METH_VARARGS|METH_KEYWORDS, __pyx_doc_15footprint_tools_5stats_5utils_2bisect},
  {0, 0, 0, 0}
};
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "utils",
    __pyx_k_This_sub_module_contains_utilit, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("utils", __pyx_methods, __pyx_k_This_sub_module_contains_utilit, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_footprint_tools__stats__utils) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "footprint_tools.stats.utils")) {
      if (unlikely(PyDict_SetItemString(modules, "footprint_tools.stats.utils", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "footprint_tools/stats/utils.pyx":11
 * 
 * cimport numpy as np
 * import numpy as np             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "footprint_tools/stats/utils.pyx":1
 * """             # <<<<<<<<<<<<<<
 * This sub-module contains utility functions for stats module
 * """
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init footprint_tools.stats.utils", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init footprint_tools.stats.utils");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
/* ObjectToMemviewSlice */
  static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_15footprint_tools_5stats_5utils_data_type_t(PyObject *obj, int writable_flag) {
    ...
    retcode = __Pyx_ValidateAndInit_memviewslice(axes_specs, 0,
                                                 ...
                                                 &__Pyx_TypeInfo_nn___pyx_t_15footprint_tools_5stats_5utils_data_type_t, stack,
                                                 &result, obj);
