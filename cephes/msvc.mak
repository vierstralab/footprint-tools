# Microsoft Visual C makefile for Cephes library
#
# Run from command line in MSDOS window:
#   \PROGRA~1\DEVSTU~1\VC\BIN\vcvars32
#   nmake -f msvc.mak
#
CC=cl
CFLAGS=/c
...
all: fti.lib mtst.exe dcalc.exe dtestvec.exe monot.exe

mtst.exe: mtst.obj fti.lib
	link mtst.obj fti.lib

mtst.obj: mtst.c
	$(CC) $(CFLAGS) mtst.c

dcalc.exe: dcalc.obj fti.lib
	link dcalc.obj fti.lib

dcalc.obj: dcalc.c dcalc.h
	$(CC) $(CFLAGS) dcalc.c

dtestvec.exe: dtestvec.obj fti.lib
	link dtestvec.obj fti.lib

dtestvec.obj: dtestvec.c dcalc.h
	$(CC) $(CFLAGS) dtestvec.c

monot.exe: monot.obj fti.lib
	link monot.obj fti.lib
...
spence.obj sqrt.obj stdtr.obj setpmsvc.obj struve.obj tan.obj \
tandg.obj tanh.obj unity.obj yn.obj zeta.obj zetac.obj isnan.obj \
mconf.h
	lib /OUT:fti.lib @msvc.rsp
...
# This version uses inline assembly language for Microsoft Visual C
setpmsvc.obj: setpmsvc.c
	cl $(CFLAGS) setpmsvc.c
